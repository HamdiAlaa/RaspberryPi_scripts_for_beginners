...
Moteur1A = 18      ## premiere sortie du premier moteur, pin 16
Moteur1B = 16     ## deuxieme sortie de premier moteur, pin 18
...
pwm1 = gpio.PWM(Moteur1E,50)   ## pwm de la pin 22 a une frequence de 100 Hz
pwm2 = gpio.PWM(Moteur2E,76)   ## pwm de la pin 22 a une frequence de 100 Hz
...
while True :
                ...
                while d < 15 :
                    while debut+2 >fin :
                        ...
                        pwm1 = gpio.PWM(Moteur1E,50)   ## pwm de la pin 22 a une frequence de 100 Hz
                        pwm2 = gpio.PWM(Moteur2E,50)   ## pwm de la pin 22 a une frequence de 100 Hz
